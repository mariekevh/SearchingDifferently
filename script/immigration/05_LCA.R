...
# read data
data = read_tsv("/Users/marieke/SearchingForBias/data/immigration/df_analysis.csv")
data = data %>%
...
saveRDS(LCAmodel2, file = "/Users/marieke/SearchingForBias/data/immigration/LCAmodels/LCAmodel2.rds")
saveRDS(LCAmodel3, file = "/Users/marieke/SearchingForBias/data/immigration/LCAmodels/LCAmodel3.rds")
saveRDS(LCAmodel4, file = "/Users/marieke/SearchingForBias/data/immigration/LCAmodels/LCAmodel4.rds")
saveRDS(LCAmodel5, file = "/Users/marieke/SearchingForBias/data/immigration/LCAmodels/LCAmodel5.rds")
saveRDS(LCAmodel6, file = "/Users/marieke/SearchingForBias/data/immigration/LCAmodels/LCAmodel6.rds")
saveRDS(LCAmodel7, file = "/Users/marieke/SearchingForBias/data/immigration/LCAmodels/LCAmodel7.rds")
saveRDS(LCAmodel8, file = "/Users/marieke/SearchingForBias/data/immigration/LCAmodels/LCAmodel8.rds")
...
library(xtable)
print(xtable(tab.modfit), type="latex", file="/Users/marieke/SearchingForBias/report/tables/model_fit.tex")
...
ggsave("/Users/marieke/SearchingForBias/report/figures/screeplot_modfit.png")
...
probs
print(xtable(probs), type="latex", file="/Users/marieke/SearchingForBias/report/tables/class5_probs.tex")
...
average <- groupby(lc, L2) %>% summarize(m=mean(value))
...
print(zp1)
ggsave("/Users/marieke/SearchingForBias/report/figures/class5_probs.png")
...
write.csv(data,"/Users/marieke/SearchingForBias/data/immigration/df_predclass.csv", row.names = FALSE)
